...
в ближайшем будущем мы займемся портом третьей игры на Windows, Linux, Android, так чтобы эмулятор для игры не понадобился.

Windows-port почти готов, скоро будет выложен.
