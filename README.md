...
# пак визуальных новелл OreGairu , фанатский перевод.
...
в ближайшем будующем мы займемся портом третьей игры на Windows, Linux, Android, так чтобы эмулятор для игры не понадобился.

Windows-port уже разработан, скоро будет выложен.
